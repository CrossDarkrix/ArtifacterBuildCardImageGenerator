...
from PySide6.QtWidgets import (QAbstractItemView, QApplication, QCheckBox, QLabel,
                               QListView, QPushButton, QMainWindow, QLineEdit, QFrame, QDialog, QDialogButtonBox, QProgressBar, QButtonGroup, QGridLayout, QFileDialog)
...
[差し替えできる入力画像サイズについて]
    ・横幅700pxまでの画像の対応となっています。700px以上を入力されますとはみ出します。

[使い方]
    ① UIDの項目にUIDを入力してください(※通常は自動入力されます)
    ② キャラクターを選択します。
    ③ 計算方式を選択します。
    ④ 差し替えしたい画像がある場合は差し替えます。ない場合はそのままで構いません。
    ⑤ ファイル名を変えたい場合は変えます。
    ⑥ 保存場所を変えたい場合は変えます。
    ⑦ 作成ボタンを押してしばらく待ちます。
    ⑧ 完成"""
...
class Ui_ArtifacterImageGenerator(object):
    def setupUi(self, ArtifacterImageGenerator):
        ...
        self.Check_Ch.setGeometry(QRect(180, 550, 200, 41))
        ...
        self.Check_EM.setGeometry(QRect(180, 600, 200, 41))
...
"QPushButton{color: #ffffff; background: #1a1a1a;}")
        ...
        self.SelectImage.setFont(font6)
        self.SelectImage.setStyleSheet(u"QPushButton:checked{background: #080808;}\n"
"QPushButton{color: #ffffff; background: #1a1a1a;}")
        self.SelectImage.setIcon(QIcon(QPixmap(ImageQt.ImageQt(concurrent.futures.ThreadPoolExecutor(os.cpu_count()*99999).submit(Image.open, BytesIO(base64.b64decode(''))).result())).scaled(80, 80, Qt.KeepAspectRatio, Qt.SmoothTransformation)))
        self.SelectImage.setIconSize(QSize(32, 32))
        self.SelectImage.clicked.connect(self.OpenImageSetPath)
        self.SelectImageLabel = QLabel(ArtifacterImageGenerator)
        self.SelectImageLabel.setObjectName(u"SelectImageLabel")
        self.SelectImageLabel.setGeometry(QRect(575, 125, 101, 41))
        self.SelectImageLabel.setFont(font6)
        self.SelectImageLabel.setStyleSheet(u"QLabel{background: #1a1a1a;}")
        self.SelectImageLabel.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.SelectImageLabel.setText(' 画像を差し替える: ')
    ...
    def retranslateUi(self, ArtifacterImageGenerator):
        ...
        self.Check_HP.setText(" HP(換算)")
        self.Check_Attack.setText(" 攻撃力(換算)")
        self.Check_Def.setText(" 防御力(換算)")
    ...
    def ArtifactsC(self, config_font, Base, D, ImageEnhance, ArtifactsIconList, ArtifactsData, optionmap, disper, ScoreData):
        ...
        for i, parts in enumerate(['flower', "wing", "clock", "cup", "crown"]):
            ...
            concurrent.futures.ThreadPoolExecutor(os.cpu_count()*99999).submit(D.text, (375 + i * 373 - int(mainoplen), 941), optionmap.get(mainop) or mainop, font=config_font(29))
            ...
            concurrent.futures.ThreadPoolExecutor(os.cpu_count()*99999).submit(Base.paste, MainIcon, (335 + i * 373 - int(mainoplen), 941), mask=MainMask)
            mainv = details['main']['value']
            if mainop in disper:
                mainvsize = D.textlength('{}%'.format(float(mainv)), config_font(49))
                concurrent.futures.ThreadPoolExecutor(os.cpu_count()*99999).submit(D.text, (375 + i * 373 - mainvsize, 971), '{}%'.format(float(mainv)), font=config_font(49))
            else:
                mainvsize = D.textlength(format(mainv, ","), config_font(49))
                concurrent.futures.ThreadPoolExecutor(os.cpu_count()*99999).submit(D.text, (375 + i * 373 - mainvsize, 971), format(mainv, ","), font=config_font(49))
            ...
            concurrent.futures.ThreadPoolExecutor(os.cpu_count()*99999).submit(D.rounded_rectangle, (373 + i * 373 - int(levlen), 1023, 375 + i * 373, 771), radius=0, outline=None, width=0)
            concurrent.futures.ThreadPoolExecutor(os.cpu_count()*99999).submit(D.text, (374 + i * 373 - levlen, 1024), '+{}'.format(details["Level"]), font=config_font(21))
            ...
            for a, sub in enumerate(details['sub']):
                ...
                if SubOP in disper:
                    ...
                    concurrent.futures.ThreadPoolExecutor(os.cpu_count()*99999).submit(D.text, (375 + i * 373 - SubSize, 1109 + 50 * a), '{}%'.format(float(SubVal)), font=config_font(25))
                else:
                    ...
                    if SubOP in ['防御力', '攻撃力', 'HP']:
                        concurrent.futures.ThreadPoolExecutor(os.cpu_count()*99999).submit(D.text, (375 + i * 373 - SubSize, 1109 + 50 * a), format(SubVal, ","), font=config_font(25),
                ...
                if details['Level'] == 20 and details['rarelity'] == 5:
                    ...
                    concurrent.futures.ThreadPoolExecutor(os.cpu_count()*99999).submit(D.text, (375 + i * 373 - nobi, 1142 + 50 * a), "+".join(map(str, psb[a])), fill=(255, 255, 255, 160), font=config_font(11))
