...
def GetPlayerInfo(uid):
    PlayerJson = json.loads(requests.get('https://enka.network/api/uid/{}?info'.format(uid)).text)
...
def GetAvatarFullInfo(uid, avatar_id):
    json_response = json.loads(requests.get('https://enka.network/api/uid/{}'.format(uid)).text)
    avatar_data = []
...
def CharacterInfoExtractor(uid, avatarInfo, score_state):
    ...
    BaseJson['Character']['Const'] = str(avatarInfo['propMap']['1002']['val'])
    ...
    BaseJson['Character']['Base']['HP'] = Decimal(avatarInfo['fightPropMap']['1']).quantize(Decimal('0'), rounding=ROUND_HALF_UP) # キャラクター基礎HP
    BaseJson['Character']['Base']['攻撃力'] = Decimal(avatarInfo['fightPropMap']['4']).quantize(Decimal('0'), rounding=ROUND_HALF_UP) # キャラクター基礎攻撃力
    BaseJson['Character']['Base']['防御力'] = Decimal(avatarInfo['fightPropMap']['7']).quantize(Decimal('0'), rounding=ROUND_HALF_UP) # キャラクター基礎防御力
...
def BuildCardCreater(data):
    ...
    config_font = lambda size : ImageFont.truetype(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/Assets/ja-jp.ttf').content),size)
    Base = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/Base/{}.png'.format(urllib.parse.quote(element))).content))
    if CharacterENName == 'Traveler':
        CharacterImage = Image.open(BytesIO(requests.get('https://enka.network/ui/{}'.format(CharacterIconFileName)).content)).convert('RGBA')
    else:
        CharacterImage = Image.open(BytesIO(requests.get('https://enka.network/ui/{}'.format(CharacterIconFileName)).content)).convert('RGBA')
    Shadow = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/Assets/Shadow.png').content)).resize(Base.size)
    ...
    if CharacterName == 'アルハイゼン':
        CharacterAvatarMask2 = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/Assets/Alhaitham.png').content)).convert('L').resize(CharacterImage.size)
    else:
        CharacterAvatarMask2 = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/Assets/CharacterMask.png').content)).convert('L').resize(CharacterImage.size)
    ...
    Weapon = Image.open(BytesIO(requests.get('https://enka.network/ui/{}'.format(WeaponIconFileName)).content)).convert('RGBA').resize((128, 128))
    ...
    WeaponRImage = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/Assets/Rarelity/{}.png'.format(WeaponRarelity)).content)).convert('RGBA')
    ...
    TalentBase = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/Assets/TalentBack.png').content))
    ...
    for i, t in enumerate(CharacterSkillIcons):
        ...
        Talent = Image.open(BytesIO(requests.get('https://enka.network/ui/{}'.format(t)).content)).resize((50, 50)).convert('RGBA')
    ...
    CBase = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/Constellation/{}.png'.format(urllib.parse.quote(element))).content)).resize((90, 90)).convert('RGBA')
    Clock = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/Constellation/{}LOCK.png'.format(urllib.parse.quote(element))).content)).convert('RGBA')
    ...
    for c, t in enumerate(CharacterTalentIcons):
        ...
        if c > int(CharacterConstellations):
            ...
            CharaC = Image.open(BytesIO(requests.get('https://enka.network/ui/{}'.format(t)).content)).convert('RGBA').resize((45, 45))
    ...
    FriendShipIcon = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/Assets/Love.png').content)).convert('RGBA')
    ...
    for k, v in CharacterStatus.items():
        ...
        try:
            ...
            opicon = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/emotes/{}.png'.format(urllib.parse.quote(k))).content)).resize((40, 40))
    ...
    BaseAtk = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/emotes/{}'.format(urllib.parse.quote('基礎攻撃力.png'))).content)).resize((23, 23))
    ...
    if WeaponSubOPKey != None:
        BaseAtk = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/emotes/{}.png'.format(urllib.parse.quote(WeaponSubOPKey))).content)).resize((23, 23))
        BaseAtkmask = BaseAtk.copy()
    ...
    if float(ScoreTotal) >= 220:
        ScoreEv = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/artifactGrades/SS.png').content))
    elif float(ScoreTotal) >= 200:
        ScoreEv = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/artifactGrades/S.png').content))
    elif float(ScoreTotal) >= 180:
        ScoreEv = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/artifactGrades/A.png').content))
    else:
        ScoreEv = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/artifactGrades/B.png').content))
    ...
    for i, parts in enumerate(['flower', "wing", "clock", "cup", "crown"]):
        ...
        Preview = Image.open(BytesIO(requests.get('https://enka.network/ui/{}'.format(ArtifactsIconList[i])).content)).resize((256, 256))
        ...
        Pmask1 = Preview.copy()
        Pmask = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/Assets/ArtifactMask.png').content)).convert('L').resize(Preview.size)
        ...
        MainIcon = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/emotes/{}.png'.format(urllib.parse.quote(mainop))).content)).convert('RGBA').resize((35, 35))
        ...
        for a,sub in enumerate(details['sub']):
            ...
            SubIcon = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/emotes/{}.png'.format(urllib.parse.quote(SubOP))).content)).resize((30, 30))
        ...
        if Score >= PointRefer[parts]['SS']:
            ScoreImage = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/artifactGrades/SS.png').content))
        elif Score >= PointRefer[parts]['S']:
            ScoreImage = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/artifactGrades/S.png').content))
        elif Score >= PointRefer[parts]['A']:
            ScoreImage = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/artifactGrades/A.png').content))
        else:
            ScoreImage = Image.open(BytesIO(requests.get('https://raw.githubusercontent.com/CrossDarkrix/ArtifacterImageGen/master/Images/artifactGrades/B.png').content))
